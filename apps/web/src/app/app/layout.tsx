...
const GROUPS: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/app/purchase/itc-register', label: 'ITC Register', icon: <Receipt size={IS} />, perm: 'purchase.view', module: 'purchase' },
      { href: '/app/purchase/reports', label: 'Purchase Reports', icon: <BarChart3 size={IS} />, perm: 'purchase.view', module: 'purchase' },
    ],
  },
  {
    title: 'Fleet',
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/app/agents', label: 'Agent Governor', icon: <Bot size={IS} />, perm: 'agents.manage' },
