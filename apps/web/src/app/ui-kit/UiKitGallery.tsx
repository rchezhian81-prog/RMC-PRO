  ...
  return (
    <div className="mn-app" style={{ minHeight: '100vh', padding: 28 }} data-testid="ui-kit">
      <div style={{ maxWidth: 1120, margin: '0 auto' }}>
        ...
        <Section
          title="Form fields (U6 — label ↔ input)"
          note="Every label is programmatically tied to its control (htmlFor/id, auto-generated by Field); help and error text are wired to the control via aria-describedby."
        >
          <Surface padded>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 }}>
              <Field label="Customer name" required help="As printed on the tax invoice">
                <Input placeholder="e.g. Sunrise Constructions" />
              </Field>
              <Field label="GSTIN" error="Enter a valid 15-character GSTIN">
                <Input defaultValue="27ABCDE" aria-invalid />
              </Field>
              <Field label="Plant">
                <Select defaultValue="">
